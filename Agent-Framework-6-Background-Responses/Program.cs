using Agent_Framework_6_Background_Responses.Agents;
...
namespace Agent_Framework_6_Background_Responses
{
        ...
        static async Task Main(string[] args)
        {
            ...
            AIAgent agent = responseClient.CreateAIAgent(
                ...
                instructions: """
                              ...
                              4. You MUST call the GenerateNewsletter function tool to save the newsletter to a file. Do NOT output the newsletter as text - you MUST pass the content to GenerateNewsletter(title, markdownContent). This step is mandatory.
                              ...
                              9. "## Predictions for the Next 90 Days" section - REQUIRED: Based on the news gathered, list 3-5 specific predictions about what might happen in AI over the next 90 days. For EACH prediction, include a confidence score (Low/Medium/High) based on the strength of evidence from the news. Format each prediction as:
